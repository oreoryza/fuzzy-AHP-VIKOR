    ...
    <div class="panel-heading">
        <form class="form-inline">
            ...
            <div class="form-group" style="float: right">
                <a class="btn btn-primary" href="?m=alternatif_tambah&periode=<?= _get('periode')?>"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
            </div>
        </form>
    </div>
    <table class="table table-bordered table-hover table-striped", style="table-layout: auto">
        ...
        foreach ($rows as $row) : ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-xs btn-warning" href="?m=alternatif_ubah&ID=<?= $row->kode_alternatif ?>&periode=<?= _get('periode') ?>"><span class="glyphicon glyphicon-edit"></span></a>
                    <a class="btn btn-xs btn-danger" href="aksi.php?act=alternatif_hapus&ID=<?= $row->kode_alternatif ?>&periode=<?= _get('periode') ?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
                </td>
            </tr>
        <?php endforeach ?>
    </table>
